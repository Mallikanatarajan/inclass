...
public class QuickSort {
	 ...
	 * to left of pivot and all greater elements to the right of pivot. This is
	 * most-frequently seen implementation of QuickSort partition, and this is also
	 * known as the Lomuto partition
	 */
...
// swap arr[i+1] and arr[high] (or pivot)
	...
	/*
	 * The main method that implements QuickSort() arr[] --> Array to be sorted, low
	 * --> Starting index, high --> Ending index. This sorts the array, and returns
	 * the time (in ms) it takes to run
	 */
...
// Recursively sort elements before partition and after partition
	 ...
	 * TODO:
	 * Implement this method and make a new method called partitionHoare that is
	 * conceptually similar to the partition method in this class. But instead of
	 * using the "default" (Lomuto) partitioning use the Hoare partitioning, as
	 * described in Prof. David Taylor's https://www.youtube.com/watch?v=v-1EGgaTFuw
	 * and elsewhere. This sorts the array, and returns the time (in ms) it takes to
	 * run
	 */
	public long sortHoare(int arr[], int low, int high) {
	    long startTime = System.currentTimeMillis();
	    if (low < high) {
	        
	        int partIdx = partitionHoare(arr, low, high);
	        
	        sortHoare(arr, low, partIdx);
	        sortHoare(arr, partIdx + 1, high);
	    }
	    return System.currentTimeMillis() - startTime;
	}
	...
	/*
	 * This is a method to print array of size n. NOTE: use of this method is
	 * optional. But this can be helpful to debug your code to make sure it really
	 * sorts. If you reduce the main's NUM_ITEMS to some manageable number (like 20
	 * or whatever) you can debug your code, and then reset main's NUM_ITEMS to a
	 * large value to make your measurements
	 */
